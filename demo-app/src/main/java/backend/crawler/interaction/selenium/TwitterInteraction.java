package backend.crawler.interaction.selenium;

import backend.crawler.interaction.WebInteraction;
import backend.crawler.property.TwitterProperty;
import backend.model.post.Tweet;
import org.openqa.selenium.*;

import static backend.crawler.helper.QueryMaker.makeQuery;
